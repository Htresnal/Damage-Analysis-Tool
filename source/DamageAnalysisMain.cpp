...
DamageAnalysisFrame::DamageAnalysisFrame(wxWindow* parent,wxWindowID id)
{
    ...
    BaseAttackDamageText = new wxStaticText(Panel1, ID_STATICTEXT6, _("Base attack damage"), wxPoint(456,96), wxDefaultSize, 0, _T("ID_STATICTEXT6"));
    ...
    StaticText1 = new wxStaticText(Panel1, ID_STATICTEXT7, _("-"), wxPoint(616,96), wxDefaultSize, 0, _T("ID_STATICTEXT7"));
    WhiteDamageInput = new wxTextCtrl(Panel1, ID_TEXTCTRL11, _("0"), wxPoint(483,120), wxSize(56,21), wxTE_PROCESS_ENTER, numsOnlyValidator, _T("ID_TEXTCTRL11"));
    WhiteDamageText = new wxStaticText(Panel1, ID_STATICTEXT10, _("Damage"), wxPoint(440,120), wxDefaultSize, 0, _T("ID_STATICTEXT10"));
    GreenDamageText = new wxStaticText(Panel1, ID_STATICTEXT11, _("Bonus damage"), wxPoint(544,120), wxDefaultSize, 0, _T("ID_STATICTEXT11"));
    ...
    BATText = new wxStaticText(Panel1, ID_STATICTEXT12, _("Base attack speed"), wxPoint(424,144), wxDefaultSize, 0, _T("ID_STATICTEXT12"));
    BATInput = new wxTextCtrl(Panel1, ID_TEXTCTRL13, _("1.0"), wxPoint(516,144), wxSize(40,21), wxTE_PROCESS_ENTER, numsFloatOnlyValidator, _T("ID_TEXTCTRL13"));
    ...
    AttackSpeedText = new wxStaticText(Panel1, ID_STATICTEXT13, _("Attack speed"), wxPoint(560,144), wxDefaultSize, 0, _T("ID_STATICTEXT13"));
    ...
    WithstandInput = new wxTextCtrl(Panel1, ID_TEXTCTRL16, _("1"), wxPoint(312,280), wxSize(56,21), wxTE_PROCESS_ENTER, numsOnlyValidator, _T("ID_TEXTCTRL16"));
    WithstandText = new wxStaticText(Panel1, ID_STATICTEXT16, _("Withstand"), wxPoint(316,264), wxDefaultSize, 0, _T("ID_STATICTEXT16"));
    WithstandText2 = new wxStaticText(Panel1, ID_STATICTEXT17, _("seconds"), wxPoint(320,300), wxDefaultSize, 0, _T("ID_STATICTEXT17"));
    ...
    aECBButtonAdd = new wxBitmapButton(Panel1, ID_BITMAPBUTTON1, wxBitmap(wxImage(_T("resources\\plus26.png"))), wxPoint(648,168), wxSize(28,28), wxBU_AUTODRAW|wxNO_BORDER|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_BITMAPBUTTON1"));
    aECBButtonAdd->SetBitmapSelected(wxBitmap(wxImage(_T("resources\\plusd26.png"))));
    aECBButtonAdd->SetToolTip(_("Add new effect"));
    dECBButtonAdd = new wxBitmapButton(Panel1, ID_BITMAPBUTTON3, wxBitmap(wxImage(_T("resources\\plus26.png"))), wxPoint(256,168), wxSize(28,28), wxBU_AUTODRAW|wxNO_BORDER|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_BITMAPBUTTON3"));
    dECBButtonAdd->SetBitmapSelected(wxBitmap(wxImage(_T("resources\\plusd26.png"))));
    dECBButtonAdd->SetToolTip(_("Add new effect"));
    dECBButtonRemove = new wxBitmapButton(Panel1, ID_BITMAPBUTTON4, wxBitmap(wxImage(_T("resources\\cross26.png"))), wxPoint(256,200), wxSize(28,28), wxBU_AUTODRAW|wxNO_BORDER|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_BITMAPBUTTON4"));
    ...
    aECBButtonRemove = new wxBitmapButton(Panel1, ID_BITMAPBUTTON2, wxBitmap(wxImage(_T("resources\\cross26.png"))), wxPoint(648,200), wxSize(28,28), wxBU_AUTODRAW|wxNO_BORDER|wxTRANSPARENT_WINDOW, wxDefaultValidator, _T("ID_BITMAPBUTTON2"));
